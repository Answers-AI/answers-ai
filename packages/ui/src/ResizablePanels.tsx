...
//   sx,
//   children
// }: React.PropsWithChildren<ResizePanelProps>) => {
...
//       direction === 'n' || direction === 's'
//         ? parseFloat(
//             getComputedStyle(actualContent).marginTop + getComputedStyle(actualContent).marginBottom
//           )
//         : parseFloat(
//             getComputedStyle(actualContent).marginLeft + getComputedStyle(actualContent).marginRight
//           );
