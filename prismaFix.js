...
const URLS = [
  ...
  'http://localhost:4000/@modal/[...all]',
  'http://localhost:4000/chat',
  'http://localhost:4000/journey',
  'http://localhost:4000/journey/new',
  'http://localhost:4000/sidekick-studio',
  'http://localhost:4000/sidekick-studio/[sidekickId]',
  'http://localhost:4000/sidekick-studio/new',
  'http://localhost:4000/settings/integrations/[[...app]]',
  'http://localhost:4000/settings/organization',
  'http://localhost:4000/settings/user',
  'http://localhost:4000/api',
  'http://localhost:4000/api/aws',
  'http://localhost:4000/api/aws/presigned-url',
  'http://localhost:4000/api/sidekicks',
  'http://localhost:4000/api/sidekicks/list',
  'http://localhost:4000/api/sidekicks/list/favorite',
  'http://localhost:4000/api/sidekicks/list/global',
  'http://localhost:4000/api/sidekicks/list/org',
  'http://localhost:4000/api/sidekicks/list/private',
  'http://localhost:4000/api/sidekicks/list/system',
  'http://localhost:4000/api/sidekicks/new',
  'http://localhost:4000/api/sources',
  'http://localhost:4000/api/sync',
  'http://localhost:4000/api/sync/file',
  'http://localhost:4000/api/sync/web'
];
